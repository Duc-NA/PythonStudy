...
role_namespace=Namespace('roles', description="a namspace for role")

role_dto=role_namespace.model(
    'role',{
...
class GetUpdateDelete(Resource):
    ...
    @role_namespace.expect(role_dto)
    @role_namespace.marshal_with(role_dto)
    def put(self):
        """
...
@role_namespace.route("/roles/<roleId>")
